    ...
    <div className="min-h-screen bg-black text-[#ededed] font-mono p-8 selection:bg-[#00FF41] selection:text-black flex flex-col justify-center items-center">
      <div className="w-full max-w-6xl">
        <header className="mb-12 text-center border-b-2 border-[#333] pb-6">
          <h1 className="text-4xl md:text-5xl font-bold uppercase tracking-tighter text-[#00FF41]">
            Global Results
          </h1>
          <p className="text-[#666] text-sm tracking-[0.3em] mt-3 uppercase">
            Jain's Got Latent — Live Leaderboard
          </p>
        </header>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-6 md:gap-8 min-w-0">
                    ...
                    <span
                      className={`font-bold text-2xl md:text-4xl tracking-wider uppercase truncate ${textStyle}`}
                    >
                      {team.name}
                    </span>
                  </div>
                  <div className="flex flex-col items-end flex-shrink-0">
                    ...
                    <span className="text-[#444] text-sm uppercase tracking-[0.2em] mt-1">
                      Points
                    </span>
                  </div>
                </motion.div>
